...
public class ExistingAccountStepDefinition extends Base {
	...
	@When("^User enter on emailaddress 'raazebratt@gmail\\.com' and password 'test'$")
	public void user_enter_on_emailaddress_raazebratt_gmail_com_and_password_test() throws Throwable {
