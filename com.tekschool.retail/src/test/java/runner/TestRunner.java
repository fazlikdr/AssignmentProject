...
@CucumberOptions(features = "classpath:Features", // Features tells cucumber options where feature files are stored
		...
		strict = false, // if set to false will fail the execution if there are any pending or undefined
						// steps
