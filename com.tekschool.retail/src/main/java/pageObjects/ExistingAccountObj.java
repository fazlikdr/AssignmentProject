...
public class ExistingAccountObj extends Base {
	...
	public void enterEmail() {
		WebDriverUtility.enterValue(inputEmail, "raazebratt@gmail.com");

	}

	public void enterPassword() {
		WebDriverUtility.enterValue(inputPassword, "test");
	}
	...
	// Scenario: Cheque Payment Method
	...
	// Scenario: Edit the information from Cheque payment method to Bank
	// Transfer
